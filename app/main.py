...
from app.utils import create_upload_directory, create_identification_file, rename_file
...
async def create_upload_files(
    ...
    for file_data in files_data:
        ...
        try:
            ...
            file_info = {
                ...
                "saved_path": new_filename,
                "description": description
            }
            uploaded_files_info.append(file_info)
            print(f"Saved file {file.filename} to {new_filename}")
    ...
    background_tasks.add_task(upload_files_to_sharepoint, upload_dir, email)
